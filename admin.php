...
<head>
<meta charset="utf-8"/>
<title>Seventh POS - Easy Your Business</title>
    ...
    <div class="hor-menu hidden-sm hidden-xs">
      <ul class="nav navbar-nav">
        ...
        <li class="classic-menu-dropdown">
          <a href="?page=home"><i class="icon-home"></i> Dasboard </a>
        </li>
        <?php
...
<div class="page-footer">
  <div class="page-footer-inner">
     2014 - 2017 &copy; Created By Seventh Media.
  </div>
...
<script>
     $(document).ready(function(){setTimeout(function(){$(".alert").fadeIn('slow');}, 700);});
     setTimeout(function(){$(".alert").fadeOut('slow');}, 3000);
</script>
