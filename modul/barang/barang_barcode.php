				...
				<div class="form-group">
					...
					<div class="col-md-3">
						...
						<div style="padding:5px;margin:5px">
							<?php echo bar128(stripslashes($dataBarcode)); ?>
						</div>
					</div>
				</div>
			</div>
...
<script type="text/javascript"> 
    function cetak()	 
    { 
    win=window.open('./cetak/barcode.php?id=<?php echo $dataKode; ?>','win','width=1400, height=500, menubar=0, scrollbars=1, resizable=0, status=0'); 
    } 
</script>