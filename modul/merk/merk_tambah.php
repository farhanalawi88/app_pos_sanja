<?php
	if(isset($_POST['btnSave'])){
		...
		if(count($message)==0){			
			$sqlSave="INSERT INTO ms_merk SET nama_merk='$txtNama', 
				  							keterangan_merk='$txtKeterangan',
											dibuat_merk='".date('Y-m-d H:i:s')."', 
											dibuat_oleh_merk='".$_SESSION['id_user']."',
											status_merk='$cmbStatus'";
			$qrySave = mysqli_query($koneksidb, $sqlSave)or die ("Gagal query".mysqli_error());
			if($qrySave){
				$_SESSION['pesan'] = 'Data merk berhasil ditambahkan';
...
<div class="portlet box grey-cascade">
	<div class="portlet-title">
		<div class="caption"><span class="caption-subject uppercase bold">Form Penambahan Merk</span></div>
		<div class="tools">
