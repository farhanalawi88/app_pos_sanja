<?php
	if(isset($_POST['btnSave'])){
		...
		if (trim($_POST['txtNama'])=="") {
			$message[] = "<b>Nama merk</b> tidak boleh kosong!";		
		}
		...
		if(count($message)==0){	
			$qryUpdate=mysqli_query($koneksidb, "UPDATE ms_merk SET nama_merk='$txtNama', 
							  							keterangan_merk='$txtKeterangan',
														status_merk='$cmbStatus'
												WHERE id_merk ='".$_POST['txtKode']."'") 
					   or die ("Gagal query update".mysqli_error());
			if($qryUpdate){
				$_SESSION['pesan'] = 'Data merk berhasil diperbaharui';
	...
	$sqlShow 		= "SELECT * FROM ms_merk WHERE id_merk='$KodeEdit'";
	$qryShow 		= mysqli_query($koneksidb, $sqlShow)  or die ("Query ambil data merk salah : ".mysqli_error());
	$dataShow 		= mysqli_fetch_array($qryShow);
	
	$dataKode		= $dataShow['id_merk'];
...
<div class="portlet box grey-cascade">
	<div class="portlet-title">
		<div class="caption"><span class="caption-subject uppercase bold">Form Perubahan Merk</span></div>
		<div class="tools">
		...
		<form action="<?php $_SERVER['PHP_SELF']; ?>" method="post" name="frmadd" class="form-horizontal">
			<div class="form-body">
				...
				<div class="form-group">
					<label class="col-lg-2 control-label">Nama Merk :</label>
					<div class="col-lg-4">
			    ...
			    <div class="row">
			        <div class="form-group">
			            <div class="col-lg-offset-2 col-lg-10">
			                ...
			                <a href="?page=datamerk" class="btn yellow"><i class="fa fa-undo"></i> Batalkan</a>
			            </div>
			        </div>
			    </div>
			</div>
